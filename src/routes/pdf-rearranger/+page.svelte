<script lang="ts">
	import PdfRearranger from '$lib/components/PdfRearranger.svelte';
</script>

<svelte:head>
	<title>DocForge — PDF Page Rearranger</title>
	<meta name="description" content="Rearrange PDF pages by dragging and dropping. Entirely client-side - your files never leave your device." />
</svelte:head>
