<script lang="ts">
	import PdfJoiner from '$lib/components/PdfJoiner.svelte';
</script>

<svelte:head>
	<title>DocForge — PDF Joiner</title>
	<meta
		name="description"
		content="Join one or more PDF documents into a single PDF. Rearrange documents before export. Entirely client-side - your files never leave your device."
	/>
</svelte:head>
